...
$id_kb = "        // KB
        ...
        <p>Dengan menguasai seluruh panduan ini, Bapak kini siap menjalankan kerajaan bisnis ritel/F&B Bapak dengan sangat profesional menggunakan SIMAJURAZ. Semoga sukses!</p>',
    ];";
...
$en_kb = str_replace(['kb_title', 'kb_desc', 'kb_sidebar', 'kb_c1_title', 'kb_c1_desc', 'kb_c2_title', 'kb_c2_desc', 'kb_c3_title', 'kb_c3_desc', 'kb_c4_title', 'kb_c4_desc', 'kb_c5_title', 'kb_c5_desc', 'kb_c6_title', 'kb_c6_desc', 'kb_c7_title', 'kb_c7_desc', 'kb_c8_title', 'kb_c8_desc'], 
                    ['kb_title', 'kb_desc', 'kb_sidebar', 'kb_c1_title', 'kb_c1_desc', 'kb_c2_title', 'kb_c2_desc', 'kb_c3_title', 'kb_c3_desc', 'kb_c4_title', 'kb_c4_desc', 'kb_c5_title', 'kb_c5_desc', 'kb_c6_title', 'kb_c6_desc', 'kb_c7_title', 'kb_c7_desc', 'kb_c8_title', 'kb_c8_desc'], 
                    $en_kb);


// Regex to replace ID
$pattern_id = "/\/\/ KB\s*'kb_title'.*?'kb_c8_desc' => '.*?<\/p>',\n\s*\]/s";
$content = preg_replace($pattern_id, trim($id_kb), $content);

// Regex to replace EN
// The structure in the file for EN ends differently, let's just do a specific search.
$pattern_en = "/\/\/ KB\s*'kb_title'.*?'kb_c8_desc' => '.*?<\/p>',\n\s*\]\n\];/s";
$content = preg_replace($pattern_en, trim($en_kb) . "\n];", $content);

file_put_contents('C:\laragon\www\SIMAJURAZ\includes\RAZlang.php', $content);
echo "Lang file v3 massive update applied!";
?>
