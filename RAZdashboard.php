...
<body data-role="<?= $user['role'] ?>">
    <div class="raz-app">
        ...
        <aside class="raz-sidebar" id="sidebar">
            ...
            <ul class="raz-sidebar-menu">
                <?php if ($isSuperAdmin): ?>
                    <!-- Menu Super Admin -->
                    <li class="raz-sidebar-section"><?= t('dash_admin_menu') ?></li>
                    <li><a href="RAZdashboard.php" class="<?= $currentPage === 'dashboard' ? 'active' : '' ?>">
                        <span class="menu-icon"><i class="ph-bold ph-squares-four"></i></span>
                        <span class="menu-text"><?= t('menu_dashboard') ?></span>
                    </a></li>
                    <li><a href="RAZsuperadmin.php" class="<?= $currentPage === 'superadmin' ? 'active' : '' ?>">
                        <span class="menu-icon"><i class="ph-bold ph-shield-check"></i></span>
                        <span class="menu-text"><?= t('dash_user_mgt') ?></span>
                    </a></li>
                    <li><a href="RAZlogout.php">
                        <span class="menu-icon"><i class="ph-bold ph-sign-out"></i></span>
                        <span class="menu-text"><?= t('topbar_logout') ?></span>
                    </a></li>
                <?php else: ?>
                    <!-- Menu Owner / Karyawan -->
                    ...
                    <li><a href="RAZpos.php" class="<?= $currentPage === 'pos' ? 'active' : '' ?>">
                        ...
                        <span class="menu-text"><?= t('menu_pos') ?></span>
                    </a></li>
                    <li><a href="RAZsettings.php" class="<?= $currentPage === 'settings' ? 'active' : '' ?>">
                        <span class="menu-icon"><i class="ph-bold ph-gear"></i></span>
                        <span class="menu-text"><?= t('menu_settings') ?></span>
                    </a></li>
                    ...
                    <?php if ($isOwner): ?>
                        ...
                        <li><a href="RAZinventory.php" class="<?= $currentPage === 'inventory' ? 'active' : '' ?>">
                            ...
                            <span class="menu-text"><?= t('menu_inventory') ?></span>
                        </a></li>
                        <li><a href="RAZfinance.php" class="<?= $currentPage === 'finance' ? 'active' : '' ?>">
                            <span class="menu-icon"><i class="ph-bold ph-wallet"></i></span>
                            <span class="menu-text"><?= t('menu_finance') ?></span>
                        </a></li>
                        <li><a href="RAZreports.php" class="<?= $currentPage === 'reports' ? 'active' : '' ?>">
                            <span class="menu-icon"><i class="ph-bold ph-chart-bar"></i></span>
                            <span class="menu-text"><?= t('menu_reports') ?></span>
                        </a></li>
                        <li><a href="RAZusers.php" class="<?= $currentPage === 'users' ? 'active' : '' ?>">
                            <span class="menu-icon"><i class="ph-bold ph-users"></i></span>
                            <span class="menu-text"><?= t('menu_employees') ?></span>
                        </a></li>
                        <li class="raz-sidebar-section">Bantuan</li>
                        <li><a href="RAZknowledgebase.php" class="<?= $currentPage === 'knowledgebase' ? 'active' : '' ?>">
                            <span class="menu-icon"><i class="ph-bold ph-book"></i></span>
                            <span class="menu-text">Panduan (KB)</span>
                        </a></li>
                    <?php endif; ?>
                <?php endif; ?>
            </ul>
        ...
        <div class="raz-main">
            ...
            <header class="raz-topbar">
                <div class="raz-topbar-left">
                    ...
                    <h1 class="raz-topbar-title"><?= t('menu_dashboard') ?></h1>
                </div>
                    ...
                    <div style="position:relative;">
                        ...
                        <div class="raz-dropdown" id="userDropdown">
                            ...
                            <button onclick="RAZ.openModal('storeSettingsModal')">
                                <i class="ph-bold ph-gear"></i> <?= t('settings_title') ?>
                            </button>
                            <?php endif; ?>
            ...
            <main class="raz-content">
                <?php if ($isSuperAdmin): ?>
                    ...
                    <div class="raz-welcome">
                        <div class="raz-welcome-content">
                            <h2>👋 <?= t('dash_welcome_super') ?>, <?= htmlspecialchars($user['full_name']) ?></h2>
                            <p><?= t('dash_desc_super') ?></p>
                    ...
                    <div class="raz-stats">
                        <div class="raz-stat-card">
                            ...
                            <div><div class="raz-stat-value" id="statTotalStores">-</div><div class="raz-stat-label"><?= t('dash_stat_tenant') ?></div></div>
                        </div>
                        <div class="raz-stat-card">
                            <div class="raz-stat-icon success"><i class="ph-bold ph-user-circle"></i></div>
                            <div><div class="raz-stat-value" id="statTotalOwners">-</div><div class="raz-stat-label"><?= t('dash_stat_active') ?></div></div>
                        </div>
                        <div class="raz-stat-card">
                            <div class="raz-stat-icon info"><i class="ph-bold ph-users"></i></div>
                            <div><div class="raz-stat-value" id="statTotalEmployees">-</div><div class="raz-stat-label"><?= t('menu_employees') ?></div></div>
                        </div>
                        <div class="raz-stat-card">
                            <div class="raz-stat-icon warning"><i class="ph-bold ph-identification-badge"></i></div>
                            <div><div class="raz-stat-value" id="statTotalUsers">-</div><div class="raz-stat-label"><?= t('dash_stat_total_users') ?></div></div>
                        </div>
                    </div>
                    ...
                    <div class="raz-card">
                        <div class="raz-card-header">
                            <h3 class="raz-card-title"><i class="ph-bold ph-buildings"></i> <?= t('dash_title_registered_stores') ?></h3>
                        </div>
                        <div id="tenantList">
                            <div class="dash-empty"><div class="empty-icon"><i class="ph-bold ph-storefront"></i></div><p><?= t('dash_no_store') ?></p></div>
                        </div>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <div class="raz-welcome">
                        <div class="raz-welcome-content">
                            <h2>👋 <?= t('dash_welcome_owner') ?>, <?= htmlspecialchars($user['full_name']) ?>!</h2>
                            <p><?= htmlspecialchars($user['store_name']) ?> — <?= t('dash_desc_owner') ?></p>
                            <div class="welcome-date"><i class="ph-bold ph-calendar"></i> <?= RAZformatTanggal(date('Y-m-d')) ?></div>
                        </div>
                    </div>
                    ...
                    <div class="raz-stats">
                        <div class="raz-stat-card">
                            ...
                            <div>
                                ...
                                <div class="raz-stat-label"><?= t('dash_stat_sales') ?> · <span id="statSalesCount">0</span></div>
                            </div>
                        </div>
                        <div class="raz-stat-card">
                            ...
                            <div>
                                ...
                                <div class="raz-stat-label"><?= t('dash_stat_profit_today') ?></div>
                            </div>
                        </div>
                        <div class="raz-stat-card">
                            ...
                            <div>
                                ...
                                <div class="raz-stat-label"><?= t('dash_stat_total_products') ?> · <span class="raz-badge danger" id="lowStockBadge" style="display:none;">0</span> stok menipis</div>
                            </div>
                        </div>
                        <div class="raz-stat-card">
                            ...
                            <div>
                                ...
                                <div class="raz-stat-label"><?= t('dash_stat_expense_today') ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dash-grid dash-grid-2">
                        ...
                        <div class="raz-card">
                            <div class="raz-card-header">
                                <h3 class="raz-card-title"><i class="ph-bold ph-chart-line-up"></i> <?= t('dash_title_sales_7days') ?></h3>
                        ...
                        <div class="raz-card">
                            <div class="raz-card-header">
                                <h3 class="raz-card-title"><i class="ph-bold ph-trophy"></i> <?= t('dash_stat_best') ?></h3>
                            </div>
                            <table class="dash-mini-table">
                                <thead><tr><th><?= t('dash_table_item_name') ?></th><th><?= t('dash_table_qty') ?></th><th><?= t('dash_table_total') ?></th></tr></thead>
                    ...
                    <div class="raz-card" style="margin-top:20px;">
                        <div class="raz-card-header">
                            <h3 class="raz-card-title"><i class="ph-bold ph-receipt"></i> <?= t('dash_title_recent_trans') ?></h3>
                            <a href="RAZreports.php" class="raz-btn raz-btn-secondary raz-btn-sm">
                                <i class="ph-bold ph-arrow-right"></i> <?= t('dash_btn_see_all') ?>
                            </a>
                        </div>
                        <div class="raz-table-wrapper">
                            <table class="dash-mini-table">
                                <thead><tr><th><?= t('dash_table_invoice') ?></th><th><?= t('dash_table_cashier') ?></th><th><?= t('dash_table_total') ?></th><th><?= t('dash_table_status') ?></th></tr></thead>
    ...
    <div class="raz-modal-overlay" id="storeSettingsModal">
        <div class="raz-modal modal-lg">
            <div class="raz-modal-header">
                <div class="raz-modal-title"><i class="ph-bold ph-gear modal-icon"></i> <?= t('settings_title') ?></div>
    ...
    <script>
window.DASH_LANG = {
    empty_trx: '<?= t('dash_empty_trx') ?>',
    empty_data: '<?= t('dash_empty_data') ?>'
};
